...
import { OddPlayers, EvenPlayers, ListofIndianPlayers, IndianPlayersMerged } from './Components/IndianPlayers';
...
function App() {
  const flag = true; // Set flag to true or false to test output
